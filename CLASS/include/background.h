...
struct background
{
  ...
  /* ---- Self-Regulating Cosmology flag and parameters ---- */
  short use_src;      /**< flag for Self-Regulating Cosmology energy transfer term */
  double src_gamma0;  /**< amplitude parameter for Self-Regulating Cosmology Q(a) */
  double src_a_peak;  /**< scale factor at peak of Q(a) Gaussian */
  double src_width;   /**< width parameter for Q(a) Gaussian in ln(a) */
